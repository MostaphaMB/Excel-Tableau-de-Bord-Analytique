...
Consolidation de plusieurs sources de données annuelles.

Nettoyage et structuration automatique via Power Query.

Analyse dynamique à l'aide de Tableaux Croisés Dynamiques (TCD).
...
Power Query : Pour l'importation, la transformation et la fusion des fichiers.

Tableaux Croisés Dynamiques (TCD) : Pour le calcul des indicateurs clés.
...
Vérification de la cohérence des champs (Dates, Produits, Chiffre d'affaires, etc.).
...
Création de TCD dédiés pour chaque indicateur métier:

Chiffre d'affaires (CA) global et par produit.

Panier moyen et volume des ventes.

Performance logistique : Délais moyens de livraison et taux de retour.

Satisfaction client : Taux moyen de satisfaction.
...
Insertion de 4 segments interactifs : Année, Produit, Région et Source de trafic.
